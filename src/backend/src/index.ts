...
function normalizeTutor(rawTutor: any) {
...
app.post("/api/interessados", async (req: Request, res: Response) => {
...
app.get("/api/interessados/:uuid_registro", async (req: Request, res: Response) => {
  try {
    const context = await requireAdmin(req, res);
    if (!context) return;
