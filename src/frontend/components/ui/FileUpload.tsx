  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-2 p-6 text-center">
        <div
          data-admin-upload="icon"
          className={`rounded-full p-3 transition-colors ${isDragging ? "bg-cyan-400 text-slate-950" : "bg-white/5 text-slate-400"}`}
        >
        ...
        <div className="space-y-1">
          ...
          <p data-admin-upload="helper" className="text-[11px] uppercase tracking-wider text-slate-500">
